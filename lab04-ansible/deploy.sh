...
if [ "$AUTO_APPLY" = true ]; then
  ...
  NODES=(
    clab-lab04-ansible-ceos1
    clab-lab04-ansible-ceos2
    clab-lab04-ansible-ceos3
    clab-lab04-ansible-ceos4
    clab-lab04-ansible-ceos5
    clab-lab04-ansible-ceos6
    clab-lab04-ansible-ceos7
    clab-lab04-ansible-ceos8
  )
