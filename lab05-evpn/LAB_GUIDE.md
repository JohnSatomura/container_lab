...
Spine1 を上、Spine2 を下に置き、Leaf 4台を中間に挟む「サンドイッチ型」で描く。
各 Spine は全 Leaf に接続（上下の縦線がそれぞれ 4 本 = 合計 8 P2P リンク）。

```
              Spine1 (ceos1, AS65000, Loopback: 1.1.1.1/32)
                   │           │           │           │
              ┌────┴────┐ ┌────┴────┐ ┌────┴────┐ ┌────┴────┐
              ...
              │VNI10010 │ │VNI10010 │ │VNI10010 │ │VNI10010 │
              └────┬────┘ └────┬────┘ └────┬────┘ └────┬────┘
                   │           │           │           │
              Spine2 (ceos2, AS65000, Loopback: 2.2.2.2/32)
                   │                                   │
...
Leaf1 (ceos3) ── Et3 (access vlan10) ── Et1 (access vlan10) ── Host1 (ceos7, Vlan10: 192.168.10.1/24)
Leaf4 (ceos6) ── Et3 (access vlan10) ── Et1 (access vlan10) ── Host2 (ceos8, Vlan10: 192.168.10.2/24)
```
